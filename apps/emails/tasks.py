...
import logging
from .models import EmailAlert, AlertStatus
...
def send_email_alert(self, alert_id):
    ...
    try:
        ...
        if alert.alert_type == 'critical_warning':
            ...
            if alert.context_data and 'warning_count' in alert.context_data and alert.context_data['warning_count'] > 1:
...
def create_consultation_alert(record_id):
    ...
    """
    try:
        from apps.patients.models import Record, ClinicalWarningSign
